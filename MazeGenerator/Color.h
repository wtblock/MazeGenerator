...
{
/////////////////////////////////////////////////////////////////////////////
// WTB: if you are doing multiple lookups of names to COLORREF, construct
// with the bIndex boolean set to true or construct normally and used
// FindNamedColor which will force the index to be built
/////////////////////////////////////////////////////////////////////////////
// protected index definitions
protected:
	// index definitions for color name key to RGB value
...
protected:
	// index of color names to RGB
	MAP_NAME_RGB m_mapColors;
	// named colors have been indexed for rapid name lookup
	bool m_bNamedColorsIndexed;

// public index attributes
public:
	// number of colors in the index
...
// public methods
public:
	// if you are doing multiple lookups of names to COLORREF, construct with
	// the bIndex boolean set to true
	...
	// Benannte Web Farben
	// -------------------
	CString GetName( CString csPrefix =  _T("#") ) const; // Liefert String mit benannter Farbe oder #RRGGBB falls kein Name bekannt
	...
	enum ENamedColor // Named Colors, could be used as COLORREF
	{
		...
		yellowselect         = 0x00CCFFFF,   // RGB(0xFF, 0xFF, 0xCC) 
		moneygreen           = 0x00DCC008,   // RGB(0x08, 0xC0, 0xDC) 
		spanishwhite         = 0x00F0FBFF,   // RGB(0xFF, 0xFB, 0xF0) 
		mediumgray           = 0x00A4A0A0,   // RGB(0xA0, 0xA0, 0xA4) 
		midgray              = 0x009B9B9B,   // RGB(0x9B, 0x9B, 0x9B) 
		midcyan              = 0x00F0CAA6,   // RGB(0xA6, 0xCA, 0xF0) 
		grayishgreen         = 0x00C0DCC0,   // RGB(0xC0, 0xDC, 0xC0) 
	  };
	  ...
	  { 
		...
		i_turquoise, i_violet, i_wheat, i_white, i_whitesmoke, i_yellow, i_yellowgreen, i_moneygreen,
		i_spanishwhite,i_mediumgray,i_midgray,i_midcyan,i_grayishgreen,
		numNamedColors
	};
